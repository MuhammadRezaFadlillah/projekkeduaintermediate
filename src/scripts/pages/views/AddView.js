import AddPagePresenter from '../presenter/AddPresenter';
...
export default class AddPage {
    ...
    #setupForm() {
        ...
        document.getElementById('image-input').addEventListener('change', async (event) => {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Foto dari Galeri Diambil!',
                text: 'Foto Anda berhasil ditambahkan dari galeri.',
    ...
    #setupCamera() {
        ...
        this.#camera.addCheeseButtonListener('#camera-take-button', async () => {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Foto dari Kamera Diambil!',
                text: 'Foto Anda berhasil ditambahkan dari kamera.',
                showConfirmButton: false,
                timer: 1500
            });
        })
    ...
    async #populateTakenPicture() {
        if (!this.#takenImage || !this.#takenImage.blob) {
            document.getElementById('image-taken').innerHTML = ''; // Clear image if no picture is taken
            return;
        }
    ...
    clearForm() {
        this.#form.reset();
        this.#removePicture(); // Clear the taken image when form is cleared
    }
